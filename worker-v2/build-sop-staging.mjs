...
await writeFile(resolve(out,'release.json'),JSON.stringify({release:'20260922-courier-inline-correction',builtAt:new Date().toISOString(),modules:apps}));
