...
await writeFile(resolve(out,'release.json'),JSON.stringify({release:'20260923-feedback-existing-plan',builtAt:new Date().toISOString(),modules:apps}));
