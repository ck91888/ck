...
await writeFile(resolve(out,'release.json'),JSON.stringify({release:'20260922-employee-bulk-import',builtAt:new Date().toISOString(),modules:apps}));
