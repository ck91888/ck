...
await writeFile(resolve(out,'release.json'),JSON.stringify({release:'20260922-dispatch-lifecycle-audit',builtAt:new Date().toISOString(),modules:apps}));
