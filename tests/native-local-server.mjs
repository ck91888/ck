...
const root=path.resolve('worker-v2/.sop-staging-assets'),DB=database(),env={DB,SOP_ENVIRONMENT:'staging',SOP_ATTENDANCE_ENABLED:'true',SOP_UPGRADE_ENABLED:'true',SOP_AUTO_OUTBOUND:'true',SOP_ROLLOUT_DEPARTMENTS:'bulk',SOP_USERS_JSON:JSON.stringify([{id:'M',name:'虚拟测试负责人',role:'manager',key:crypto.randomUUID()}])};
...
}catch(e){res.statusCode=500;res.end(e.message);}});server.listen(7831,'127.0.0.1',()=>console.log('Local full-system acceptance fixture listening on 7831'));
