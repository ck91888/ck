...
var I18N = {
  ...
  status_pending_issue: { zh: "待下发", ko: "배정대기" },
  status_working: { zh: "操作中", ko: "작업중" },
  status_ready_to_ship: { zh: "待出库", ko: "출고대기" },
  status_shipped: { zh: "已出库", ko: "출고완료" },
  ...
  status_partially_completed: { zh: "部分入库完成", ko: "부분 입고 완료" },
